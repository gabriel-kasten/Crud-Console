...
{
    internal class PokemonMenu
    {
        public void displayPokemonInfo(Rootobject data)
        {
            PokemonImage.ConvertImg(data.sprites.front_default.ToString());
            ...
            string[] PokedexOptions = { "Salvar", "Novo Aleatório", "Sair" };
            Menu pokedexMenu = new Menu(PokedexOptions, "O que deseja fazer com o pokemon?");
            int selectedIndex = pokedexMenu.Run();
        ...
        public void displayManceiramon()
        {
            string manceiramon = @"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&@@@&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&@&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
